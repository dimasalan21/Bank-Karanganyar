...
export default function AduanDetail({ item, onClose }: AduanDetailProps) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-sm font-semibold text-gray-700 mb-5 uppercase tracking-wide">Informasi Nasabah</h2>
        ...
        <div className="space-y-5">
          {/* Status Aduan */}
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-sm font-semibold text-gray-700 mb-4 uppercase tracking-wide">Status Aduan</h2>
