...
// =========================================================
// IMPORT ASET GAMBAR PERSON ANDA
// =========================================================
import imgHeroPerson from './assets/person.png'; 

export default function App() {
  const [currentPage, setCurrentPage] = useState<'home' | 'formulir' | 'keberatan'>('home');
        ...
        <>
          ...
          <section className="relative w-full h-auto md:h-[75vh] md:min-h-[550px] flex flex-col md:flex-row items-center overflow-hidden bg-[#F4F8FB]">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-8 pb-16 md:py-0">
              <div className="max-w-xl text-center md:text-left mx-auto md:mx-0">
                ...
                <button 
                  onClick={() => setCurrentPage('formulir')}
          ...
          <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 relative z-20">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-10 max-w-5xl mx-auto">
              ...
              <div onClick={() => setCurrentPage('formulir')} className="bg-white rounded-3xl p-6 sm:p-10 shadow-xl border border-gray-100 hover:shadow-2xl hover:border-blue-900 hover:-translate-y-2 transition-all duration-300 group flex flex-col items-center text-center cursor-pointer">
              ...
              <div onClick={() => setCurrentPage('keberatan')} className="bg-white rounded-3xl p-6 sm:p-10 shadow-xl border border-gray-100 hover:shadow-2xl hover:border-red-600 hover:-translate-y-2 transition-all duration-300 group flex flex-col items-center text-center cursor-pointer">
            ...
            <div className="mt-40 max-w-4xl mx-auto mb-20">
              ...
              <div className="space-y-6">
                <details className="group bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-all">
                  ...
                  <div className="text-gray-600 px-6 sm:px-8 pb-6 sm:pb-8 text-sm sm:text-base leading-relaxed border-t border-gray-50 pt-6 mt-2">Layanan E-Formulir ini memungkinkan Anda untuk mengajukan permohonan informasi dan pengajuan keberatan secara digital. Anda cukup mengisi formulir pada sistem, mengunduh hasilnya dalam bentuk PDF, mencetaknya, dan menyerahkannya ke kantor kami.</div>
                </details>
                <details className="group bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-all">
                  <summary className="flex justify-between items-center font-bold cursor-pointer list-none p-6 sm:p-8 text-gray-900 [&::-webkit-details-marker]:hidden">
                  ...
                  <div className="text-gray-600 px-6 sm:px-8 pb-6 sm:pb-8 text-sm sm:text-base leading-relaxed border-t border-gray-50 pt-6 mt-2">Proses penyelesaian atau tindak lanjut permohonan informasi maupun aduan standar biasanya memakan waktu maksimal 10 hari kerja sejak dokumen fisik dan persyaratan Anda diterima dengan lengkap oleh petugas kami di kantor.</div>
                </details>
                <details className="group bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-all">
                  <summary className="flex justify-between items-center font-bold cursor-pointer list-none p-6 sm:p-8 text-gray-900 [&::-webkit-details-marker]:hidden">
                  ...
                  <div className="text-gray-600 px-6 sm:px-8 pb-6 sm:pb-8 text-sm sm:text-base leading-relaxed border-t border-gray-50 pt-6 mt-2">Tidak. Anda tidak perlu membuat akun atau melakukan login. Sistem ini dirancang untuk kemudahan publik. Anda dapat langsung memilih layanan, mengisi formulir yang tersedia, dan mengunduh hasilnya secara langsung tanpa hambatan.</div>
                </details>
              </div>
            </div>
          </main>
          ...
          {/* ========================================================= */}
          {/* SECTION CONTACT US - REVISI JARAK MOBILE */}
          {/* Mengubah padding dan margin untuk kerapatan di mobile */}
          {/* ========================================================= */}
