...
// =========================================================
// KOMPONEN HALAMAN UTAMA (BERANDA)
// =========================================================
const Home = () => {
  // Hook dari React Router untuk pindah halaman
  ...
  return (
    <Router>
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        {/* DEFINISI ROUTING URL */}
        <Routes>
          
          {/* HALAMAN UTAMA (Beranda) - Akses via http://localhost:5173/ */}
          <Route path="/" element={<Home />} />

          {/* HALAMAN FORMULIR PERMOHONAN - Akses via http://localhost:5173/permohonan */}
          ...
          {/* HALAMAN FORMULIR KEBERATAN - Akses via http://localhost:5173/keberatan */}
          <Route path="/keberatan" element={
            <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 animate-in fade-in duration-300">
              <Link 
                to="/" 
